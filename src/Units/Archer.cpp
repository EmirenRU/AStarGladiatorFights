...
Archer::Archer(Map& map, int _x, int _y, int _x1, int _y1, char ch)
{
    this->map = map;
    mapHeight = map.getH();
    mapWidth = map.getW();
...
Node* &Archer::getStartNode() { return start; }
string Archer::getClassName() { return "Archer"; }

int Archer::getHitChance() { return HitChance; }
float Archer::getHP() { return HP; }
float Archer::getArmor() { return Armor; }
float Archer::getDMG() { return DMG; }
char Archer::getCharacter() { return ch; }
void Archer::setHitChances(int hitChances) { this->HitChance = hitChances; }
void Archer::setHP(float hp) { this->HP = hp; }
void Archer::setStartAndEndNode(Node *&start, Node *&end)
{
    this->start = start;
    this->end   = end;
}
